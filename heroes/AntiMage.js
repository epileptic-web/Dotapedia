...
export  function AntiMage() {
  return (
    <nav >
      ...
      <h1 className = 'name'> Anti Mage</h1>
       <img  style = {{height:150}} src = 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/heroes/antimage_full.png?v=6299534?v=6299534' />
...
<div className = 'skills' >
          ...
          <div className = 'MB' > 
      <img style = {{width: 105, height:105}} src='https://ru.dotabuff.com/assets/skills/anti-mage-mana-break-5003-ad4049bc111c7a3d58a8c1b3c727de0df52171db12e3e422e26db4adf52f9cd7.jpg'></img> 
       <Text style = {{color:'#fff'}}>  MANA BREAK</Text>
                     ...
                     <div className = 'blink'>
                       <img style = {{width: 105, height:105}} src='https://ru.dotabuff.com/assets/skills/anti-mage-blink-5004-5d2e0ccb238493cef0c44786d626db5e8090cc905751f3611b42d2183a62bd9a.jpg'/>
  ...
  <TouchableOpacity onPress = {()=>{ alert('СПОСОБНОСТЬ: не направленное\nМОЖНО РАЗВЕЯТЬ: Да\nУвеличивает сопротивление магическому урону. Можно применить, чтобы создать вокруг себя противомагический щит, который полностью отражает все направленные заклинания обратно во врага.\nСОПРОТИВЛЕНИЕ МАГИИ: 15% / 25% / 35% / 45%\nДЛИТЕЛЬНОСТЬ: 1.2\nВремя каста: 0s\nКулдаун: 15 / 11 / 7 / 3\nМана: 45 / 50 / 55 / 60\nСконцентрировавшись, Антимаг обращает врождённое сопротивление в точную контратаку.')}}>
    <div className = 'conterSpell'>
       <img style = {{width: 105, height:105}} src = 'https://ru.dotabuff.com/assets/skills/anti-mage-counterspell-7314-66efa4ff5922963fcb51d79c06ee7d5ae011ca8931432729f57063b380c06c3e.jpg'/>
  <Text style = {{color:'#fff'}}>  COUNTERSPELL</Text>
       ...
       <img style = {{width: 105, height:105}} src = "https://ru.dotabuff.com/assets/skills/anti-mage-mana-void-5006-87ccdcde7c553a6863f7d2a7781078b825fbc90384743fd5d547b5392f73b1f6.jpg"/>
...
<div className = 'itemsHero'>
  <TouchableOpacity className = 'early' order = '1' onPress = {()=> {alert(Tango.alert)}}>
...
<div className='stats'>
 ...
 <img style = {{width: 50, height: 50, marginBlockStart: 5, marginLeft: 200}} src = 'https://ru.dotabuff.com/assets/hero_int-76ea2af3bdf60a1c92d82a1fc0845d47a071cfacfca111aa2d5e43fbae01b580.png'></img>
     <Text style = {{color: '#fff', marginLeft: 200}}>23 + 1.3</Text>
     <Text style = {{color: '#fff', marginLeft: 200}}>24 + 2.8</Text>
     <Text style = {{color: '#fff', marginLeft: 200}}>12 + 1.8</Text>
     <Text style = {{color: '#fff', fontSize: 15}}><br/> Скорость передвижения	310<br/> Поле зрения	1800/800<br/> Броня	2.36<br/> Базовое время атаки	1.4<br/> Урон	53 - 57<br/> Замах на атаку	0.3</Text>
    </div>
